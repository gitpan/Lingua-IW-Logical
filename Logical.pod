...
There are some unresolved things with constructions like "H-1", where H is hebrew letter. The parser now think it's number "-1", while in thebre this might as well be dash. Also, seems that Word like to write percents as "%12.5". This is also not rendered well. I'm thinking how to resolve these issues. 
